...
public class EmployeeBook {
    ...
    public LinkedList<Employee> listAll(int currentDepartment) { // Выводим данные сотрудников выбранного отдела
    ...
    public LinkedList<String> getAllFullName() { // Выводим ФЫО по всем сотрудника в консоль
    ...
    public LinkedList<Employee> listLessSalary(int lessSalary) { // Выводим данные сотрудников, зарплата которых меньше указанной
    ...
    public LinkedList<Employee> listMoreSalary(int moreSalary) { // Выводим данные сотрудников, зарплата которых больше указанной
    ...
    public boolean changeDepartment(String fullName, int newDepartment) { // Изменить отдел указанному ФЫО
        if (newDepartment <= 0 && newDepartment > EmployeeBook.departmentQuantity) {
            return false;
        }
        for (Employee value : employee) {
            if (value != null && value.getFullName().equals(fullName)) {
