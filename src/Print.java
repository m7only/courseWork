...
public class Print {
    ...
    public void printDepartmentMenu(int currentDepartment) {
        System.out.println();
    ...
    public void printAllEmployee(EmployeeBook employeeBook) {
    ...
    public void printAllEmployee(EmployeeBook employeeBook, int currentDepartment) {
    ...
    public void printAllEmployeeByDepartment(EmployeeBook employeeBook) {
    ...
    public void printMonthSalary(EmployeeBook employeeBook) {
        System.out.printf("Бюджет зарплат за месяц: %d%n", employeeBook.getMonthSalary());
    }

    public void printMonthSalary(EmployeeBook employeeBook, int currentDepartment) {
    ...
    public void printMinSalaryEmployee(EmployeeBook employeeBook) {
        System.out.printf("Данные сотрудника с минимальной зарплатой: %s%n", employeeBook.getMinSalaryEmployee());
    }

    public void printMaxSalaryEmployee(EmployeeBook employeeBook) {
        System.out.printf("Данные сотрудника с максимальной зарплатой: %s%n", employeeBook.getMaxSalaryEmployee());
    }

    public void printMinSalaryEmployee(EmployeeBook employeeBook, int currentDepartment) {
    ...
    public void printMaxSalaryEmployee(EmployeeBook employeeBook, int currentDepartment) {
    ...
    public void printAverageSalary(EmployeeBook employeeBook) {
        System.out.printf("Средняя зарплата: %.2f\n", employeeBook.getAverageSalary());
    }

    public void printAverageSalary(EmployeeBook employeeBook, int currentDepartment) {
        System.out.printf("Средняя зарплата в отделе %d: %.2f%n", currentDepartment, employeeBook.getAverageSalary(currentDepartment));
    }

    public void printAllFullName(EmployeeBook employeeBook) {
    ...
    public void printLessSalary(int rateLess, EmployeeBook employeeBook) {
    ...
    public void printMoreSalary(int rateMore, EmployeeBook employeeBook) {
